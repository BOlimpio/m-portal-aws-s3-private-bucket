data "aws_iam_policy_document" "private" {
  source_policy_documents = concat(
    ...
    [
      var.enable_deny_unencrypted_object_uploads ? data.aws_iam_policy_document.deny_unencrypted_object_uploads[0].statement : [],
      var.enable_default_policy ? data.aws_iam_policy_document.default[0].statement : [],
      var.enable_restricted_bucket_access ? data.aws_iam_policy_document.access_control[0].statement : [],
      var.enable_whitelists ? data.aws_iam_policy_document.whitelists[0].statement : [],
